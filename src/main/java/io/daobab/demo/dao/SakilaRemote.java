...
import io.daobab.target.database.remote.RemoteDatabaseClient;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Component;
import org.springframework.web.client.RestTemplate;

@Component
public class SakilaRemote extends RemoteDatabaseClient {
    ...
    protected ResponseWrapper callEndpoint(Query<? extends Entity, ?, ?> query, boolean singleResult) {
        ...
        final String url = "http://localhost:9000/export/db";
